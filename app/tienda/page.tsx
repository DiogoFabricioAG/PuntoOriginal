...
export default function TiendaPage() {
  ...
  // Estado para el filtro de concursos
  ...
  // Se añadió la propiedad contestWinner a los productos
  const productos = [
    {
      id: 1,
    ...
    },
    {
      ...
      inStock: true,
      contestWinner: "Concurso Diseño Urbano 2024",
    },
    {
      id: 4,
    ...
    },
    {
      ...
      sizes: ["39", "40", "41", "42", "43", "44"],
      inStock: true,
      contestWinner: "Concurso de Verano Neón 2023",
    },
    {
      id: 9,
      name: "Gris Elegance",
    ...
    },
    {
      ...
      inStock: true,
      contestWinner: "Edición Especial Ganadora 2025",
    },
    {
      id: 12,
      name: "Blanca Pure",
  ...
  // Generar lista de concursos dinámicamente 
  const concursos = [
    "Todos",
    // @ts-ignore
    ...new Set(productos.map(p => p.contestWinner).filter(Boolean))
  ]
  ...
  const addToCart = (producto: (typeof productos)[0]) => {
    ...
    if (typeof window !== "undefined") {
      ...
      notification.className =
        "fixed top-4 right-4 bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-lg shadow-xl p-4 z-50 max-w-sm animate-cart-success";
  ...
  // Se añadió lógica de filtro por concurso 
  const filteredProducts = productos.filter((producto) => {
    ...
    // Filtro por concurso ganado
    // @ts-ignore
    const matchesContest = selectedContest === "Todos" || producto.contestWinner === selectedContest

    return matchesSearch && matchesCategory && matchesSize && matchesPrice && matchesFeatures && matchesContest
  })
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Descubre nuestra colección completa de zapatillas personalizables y
          ...
          >
            <Card className="sticky top-4">
              <div className="p-6 space-y-6">
                ...
                {/* Filtro por Concursos */}
                <div>
                  <Label className="text-base font-medium">Concursos Ganados</Label>
                    ...
                    {tallas.map((talla) => (
                      ...
                      >
                        <Checkbox
                          ...
                          onCheckedChange={() =>
                            toggleFilter(talla, selectedSizes, setSelectedSizes)
                          }
                        />
          ...
          <div className="flex-1">
            ...
            <div className="mb-4">
              <p className="text-gray-600">
                Mostrando {sortedProducts.length} de {productos.length}{" "}
                productos
              </p>
            </div>
                  ...
                  <CardContent className="p-0">
                    ...
                    >
                      <div className={viewMode === "list" ? "md:flex-1" : ""}>
                        ...
                        {/* Mostrar si el producto es ganador de un concurso */}
                        {/* @ts-ignore */}
                        {producto.contestWinner && (
                          <div className="mb-3 flex items-center space-x-2 text-amber-600">
                            <Trophy className="w-4 h-4" />
                            <span className="text-sm font-semibold">Ganador: {producto.contestWinner}</span>
                          </div>
                        )}
